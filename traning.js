...
const HeadingsAndText = [
    ...
    {heading: "Tennisskola: Fortsättning (vuxen)", text: "För dig över 16 år som gått minst två terminer i tennisskola grund eller kan tennisens grunder sen tidigare och nu vill lära dig mer för att på sikt nå till tävling. Blandad rullstolstennis och annan. 1.5 timmar varje tisdag kl 17 och lördgar kl 9"},
